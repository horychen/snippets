...
void SVGEN_Drive(SVGENDQ* ptrV, float U0){ // U0 maximum is G.Voltage_DC_BUS, minimum is - G.Voltage_DC_BUS,
    ...
    v=(*ptrV);
    Sector = 0;
    t_voltage=ctrl.inverter->vdc*0.577367;

    REAL Inverse_Voltage_DC_BUS = 1.0 / ctrl.inverter->vdc;
    temp_sv1=(v.Ubeta*0.8660254)*Inverse_Voltage_DC_BUS;
    temp_sv2=(1.5*v.Ualpha)     *Inverse_Voltage_DC_BUS;

    float Tz;
    Tz = U0 * Inverse_Voltage_DC_BUS;
